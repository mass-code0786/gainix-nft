...
export interface GainixNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "adminMint"
...
export namespace AdminMintEvent {
...
export namespace AdminUpdatedEvent {
  export type InputTuple = [account: AddressLike, isAdmin: boolean];
  export type OutputTuple = [account: string, isAdmin: boolean];
  export interface OutputObject {
    account: string;
    isAdmin: boolean;
  }
...
export namespace BaseTokenUriUpdatedEvent {
  export type InputTuple = [previousBaseUri: string, newBaseUri: string];
  export type OutputTuple = [previousBaseUri: string, newBaseUri: string];
  export interface OutputObject {
...
export interface GainixNFT extends BaseContract {
  connect(runner?: ContractRunner | null): GainixNFT;
  waitForDeployment(): Promise<this>;

  interface: GainixNFTInterface;
  ...
  ): TypedContractMethod<[newBaseTokenUri: string], [void], "nonpayable">;
  getFunction(
  ...
  getEvent(
    ...
    AdminMintEvent.InputTuple,
    AdminMintEvent.OutputTuple,
    AdminMintEvent.OutputObject
  >;
  getEvent(
    key: "AdminUpdated"
  ): TypedContractEvent<
  ...
  filters: {
    "AdminMint(address,address,uint256,string)": TypedContractEvent<
      AdminMintEvent.InputTuple,
      AdminMintEvent.OutputTuple,
      AdminMintEvent.OutputObject
    >;
    AdminMint: TypedContractEvent<
      AdminMintEvent.InputTuple,
      AdminMintEvent.OutputTuple,
      AdminMintEvent.OutputObject
    >;
